        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-4">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>Lista de Prestaciones Reclamadas</strong>
                    </li>
                </ol>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Lista de Prestaciones Reclamadas</h5>
                            <div class="ibox-tools">
                                <g:link class="btn btn-xs btn-primary" action="create" style="color:#ffffff;">Nueva Prestación Reclamada</g:link>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="table-responsive col-md-8">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <g:each in="${prestacionReclamadaList}" status="i" var="prestacionReclamada">
                                                <tr>
                            ...
                            <div class="pagination row">
                                <g:paginate total="${prestacionReclamadaCount ?: 0}" />
                            </div>
                        </div>
                    </div>
                </div>
