                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <g:link class="btn btn-xs btn-primary" action="index" style="color:#ffffff;">Lista de Delitos</g:link>
                                </div>
                            </div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>${delito?.id}</td>
                                            <td>${delito?.nombre}</td>
                                            <td>${delito?.tipoDeAsignacion}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            <g:form resource="${this.delito}" method="DELETE">
                                <div class="hr-line-dashed"></div>
                                <div class="row">
                                    <div class="col-lg-6 col-lg-offset-2">
                                        <div class="form-group">
                                            <g:link class="edit" class="btn btn-primary" action="edit" resource="${this.delito}">Editar</g:link>
