...
<html>
    <head>
        ...
        <script src="/sicj/assets/jquery-2.1.1.js" type="text/javascript" dir="assets/js" file="jquery-2.1.3.js"></script>
    ...
    <body class="gray-bg">
        <div class="middle-box text-center animated fadeInDown">
            <h1>403</h1>
            <h3 class="font-bold">Acceso Restringido</h3>

            <div class="error-desc">
                <p style="text-align: justify;">Lo sentimos, no cuenta con los privilegios suficientes para visualizar la página o el recurso solicitado.</p>
                <br/>
                <div class="row">
                    <a href="/sicj/dashboard/index" class="btn btn-warning">Regresar al Tablero de Control</a>
                </div>
            </div>
        </div>
    </body>
