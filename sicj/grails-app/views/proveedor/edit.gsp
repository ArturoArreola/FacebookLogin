        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-4">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>Edición de Proveedores</strong>
                    </li>
                </ol>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <g:form resource="${this.proveedor}" method="PUT" class="form-horizontal">
                                <g:hiddenField name="version" value="${this.proveedor?.version}" />
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                        <g:link action='show' id='${proveedor.id}' class="btn btn-warning">Regresar</g:link>
