        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-4">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>Edición de Delegaciones</strong>
                    </li>
                </ol>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <g:form resource="${this.delegacion}" method="PUT" class="form-horizontal">
                                <g:hiddenField name="version" value="${this.delegacion?.version}" />
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12 col-sm-offset-2">
                                        <g:link action='show' id='${delegacion.id}' class="btn btn-warning">Regresar</g:link>
