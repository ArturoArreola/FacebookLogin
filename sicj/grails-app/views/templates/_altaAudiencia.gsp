<div class="col-lg-12">
    <g:if test="${juicio.estadoDeJuicio.id != 4 && juicio.estadoDeJuicio.id != 6 && juicio.estadoDeJuicio.id != 7}">
        <g:form class="form-horizontal" id="modalAudienciaForm" name="modalAudienciaForm">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group" id="data_1">
                        ...
                        <div id="divFechaAudiencia" class="input-group date datepicker" data-date-days-of-week-disabled="0,6">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <g:submitToRemote onSuccess="mostrarAudiencia(data);" onFailure="alert('algo fallo');" onComplete="" class="btn btn-primary" url="[controller: 'audienciaJuicio',action: 'save']" method="POST" value="Guardar"/>
