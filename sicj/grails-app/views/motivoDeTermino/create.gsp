        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-4">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>Registro de Motivos de Término</strong>
                    </li>
                </ol>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Registrar Motivo de Término</h5>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            <g:select data-placeholder="Elija la materia..." required class="chosen-select" style="width:350px;" tabindex="2" name="materia" from="${mx.gox.infonavit.sicj.catalogos.Materia?.list(sort:'id')}" optionKey="id" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
