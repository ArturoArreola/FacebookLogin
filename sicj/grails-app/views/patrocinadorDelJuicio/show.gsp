        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-4">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>Ver Patrocinador del Juicio</strong>
                    </li>
                </ol>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Ver Patrocinador del Juicio</h5>
                            ...
                            <div class="table-responsive col-md-6">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>${patrocinadorDelJuicio?.id}</td>
                            ...
                            <g:form resource="${this.patrocinadorDelJuicio}" method="DELETE">
                                <div class="hr-line-dashed"></div>
                                <div class="row">
                                    <div class="col-lg-6 col-lg-offset-2">
                                        <div class="form-group">
                                            <g:link class="edit" class="btn btn-primary" action="edit" resource="${this.patrocinadorDelJuicio}">Editar</g:link>
