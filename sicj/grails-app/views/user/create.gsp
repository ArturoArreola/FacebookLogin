...
<body>
    ...
    <div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <form class="form-horizontal" action="/sicj/user/saveUser" method="post" name="saveForm" id="saveForm">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="tabs-container">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a data-toggle="tab" href="#tab-6">Datos Generl</a></li>
                                    ...
                                    <div class="tab-content ">
                                        <div id="tab-6" class="tab-pane active">
                                            <div class="panel-body">
                                                <div class="alert alert-info">
                                                    <p><span class="badge badge-warning">Importante:</span> Para que el nuevo usuario pueda ingresar al sistema es necesario que le sea asignado un perfil de usuario.</p>
                                                </div>
                                                <div class="ibox-content">
                                                    ...
                                                    <div class="form-group"><label class="col-sm-2 control-label">Apellido Paterno </label>
                                                        <div class="col-sm-5"><input name="apellidoPaterno" id="apellidoPaterno" style="text-transform: uppercase" type="text" class="form-control" onBlur="this.value=this.value.toUpperCase();" value="${user?.apellidoPaterno}" required /></div>
                                                    </div>
                                                    <div class="hr-line-dashed"></div>
                                                    <div class="form-group"><label class="col-sm-2 control-label">Apellido Materno </label>
                                                        <div class="col-sm-5"><input name="apellidoMaterno" id="apellidoMaterno" style="text-transform: uppercase" type="text" class="form-control" onBlur="this.value=this.value.toUpperCase();" value="${user?.apellidoMaterno}" required /></div>
                                                    </div>
                                                    <div class="hr-line-dashed"></div>
                                                    ...
                                                    <div class="form-group"><label class="col-sm-2 control-label">Tipo de Usuario <br/></label>
                                                        <div class="col-sm-10">
                                                            <label class="radio-inline"> 
                                                                <input type="radio" onchange="generarUsername();" onclick="mostrarGerente();" value="INTERNO" name="tipoDeUsuario" id="tipoDeUsuario" checked="${user?.tipoDeUsuario.equals('INTERNO')}" /> Interno
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input type="radio" onchange="generarUsername();" onclick="mostrarProveedor();" value="PROVEEDOR" name="tipoDeUsuario" id="tipoDeUsuario" checked="${user?.tipoDeUsuario.equals('PROVEEDOR')}" /> Externo (Proveedor)
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input type="radio" onchange="generarUsername();" onclick="mostrarResponsable();" value="EXTERNO" name="tipoDeUsuario" id="tipoDeUsuario" checked="${user?.tipoDeUsuario.equals('EXTERNO')}" /> Externo (Despacho)
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="hr-line-dashed"></div>
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div id="divDespacho">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="input-group">
                                                                        <select class="chosen-select" id="despacho" name="despacho.id" data-placeholder="Elija primero una Delegación..." style="width:350px;" tabindex="2">
                                                                        </select>    
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div id="divProveedor">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="input-group">
                                                                        <select class="chosen-select" id="proveedor" name="proveedor.id" data-placeholder="Elija primero una Delegación..." style="width:350px;" tabindex="2">
                                                                        </select>    
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <input id="username" name="username" style="text-transform: uppercase" type="text" class="form-control" onBlur="this.value=this.value.toUpperCase();" value="${user?.username}">
                                                            </div>
                                        ...
                                        <div id="tab-7" class="tab-pane">
                                            <div class="panel-body">
                                                ...
                                                <div class="ibox-content">
                                                    <% def perfilesList = mx.gox.infonavit.sicj.admin.Perfil.list()%>
                                                    <g:if test='${perfilesList}'>
                                                        <g:each var='perfil' in='${perfilesList}'>
                                                            <div class="row">
                                                    ...
                                                    <g:if test='${authorityList}'>
                                                        <g:each var='role' in='${authorityList}'>
                                                            <div class="checkbox checkbox-success checkbox-circle tooltip-demo">
                                                                ...
                                                                <label for='${authority}' data-toggle='tooltip' data-placement='right' title='${role.descripcion}'><strong>${authority}</strong></label>
                                                            </div>
                                                        </g:each>
                                                    </g:if>
                                                    <g:else>
        ...
        var lpad = leftPad($('#delegacion').val(),2);
        if($("input:radio[name=tipoDeUsuario]:checked").val() == 'INTERNO'){
        $('#username').val(('IN' + ($('#nombre').val().replace(/\s/g,'').substring(0,2)) + ($('#apellidoPaterno').val().replace(/\s/g,'').substring(0,2)) + ($('#apellidoMaterno').val().replace(/\s/g,'').substring(0,2))));
        ...
        $('#username').val(('IE' + ($('#nombre').val().replace(/\s/g,'').substring(0,2)) + ($('#apellidoPaterno').val().replace(/\s/g,'').substring(0,2)) + ($('#apellidoMaterno').val().replace(/\s/g,'').substring(0,2)) + lpad));
        }
        }
